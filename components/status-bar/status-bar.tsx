...
import { ChevronUp, ChevronDown, List as QueueIcon, LucideIcon, X } from 'lucide-react'
    ...
    return (
        <>
            ...
            {!statusBar.open && (
                <motion.div
                    key="open"
                    className="w-full z-[20] flex items-center justify-center absolute bottom-2"
                    initial={{ y: 100, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                ...
                >
                    <Button
                        ...
                        className="sm:w-[20%] w-[80%] flex items-center justify-center h-10"
                    >
